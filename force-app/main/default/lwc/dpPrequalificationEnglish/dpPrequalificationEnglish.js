...
import { OMNIDEF } from './dpPrequalificationEnglish_def.js';
import tmpl from './dpPrequalificationEnglish.html';
import tmpl_nds from './dpPrequalificationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dpPrequalificationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
