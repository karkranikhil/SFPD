...
import { OMNIDEF } from './dpAssignedTaskEnglish_def.js';
import tmpl from './dpAssignedTaskEnglish.html';
import tmpl_nds from './dpAssignedTaskEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dpAssignedTaskEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
