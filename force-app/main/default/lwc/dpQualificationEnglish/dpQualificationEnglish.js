...
import { OMNIDEF } from './dpQualificationEnglish_def.js';
import tmpl from './dpQualificationEnglish.html';
import tmpl_nds from './dpQualificationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dpQualificationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
