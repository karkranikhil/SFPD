...
import { OMNIDEF } from './pdPrequalificationEnglish_def.js';
import tmpl from './pdPrequalificationEnglish.html';
import tmpl_nds from './pdPrequalificationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pdPrequalificationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
