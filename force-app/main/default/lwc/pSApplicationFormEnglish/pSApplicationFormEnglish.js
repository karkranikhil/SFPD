...
import { OMNIDEF } from './pSApplicationFormEnglish_def.js';
import tmpl from './pSApplicationFormEnglish.html';
import tmpl_nds from './pSApplicationFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pSApplicationFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
